...
public class PopulaDados {
    ...
    public void cadastrarMusica(){
        ...
        listaMusic.add(music1);
        listaMusic.add(music2);

        for (Music music : listaMusic) {
            
            Music salvarMusic = catalogRepository.save(music);
            System.out.println(salvarMusic.getId());
        }
